...
class CinemaFilmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cinema_film" do
    assert_difference('CinemaFilm.count') do
      post cinema_films_url, params: { cinema_film: { cinema_id: @cinema_film.cinema_id, film_id: @cinema_film.film_id } }
    end
  ...
  test "should update cinema_film" do
    patch cinema_film_url(@cinema_film), params: { cinema_film: { cinema_id: @cinema_film.cinema_id, film_id: @cinema_film.film_id } }
